...
class BulletinsControllerTest < ActionController::TestCase
  ...
  test "should create bulletin" do
    assert_difference('Bulletin.count') do
      post :create, bulletin: { content: @bulletin.content, creator_id: @bulletin.creator_id, display_until: @bulletin.display_until, title: @bulletin.title }
    end
  ...
  test "should update bulletin" do
    put :update, id: @bulletin, bulletin: { content: @bulletin.content, creator_id: @bulletin.creator_id, display_until: @bulletin.display_until, title: @bulletin.title }
    assert_redirected_to bulletin_path(assigns(:bulletin))
  end
