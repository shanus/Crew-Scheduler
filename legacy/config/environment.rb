...
ADMINEMAIL = 'donotreply@yarmouth-rowing.org' unless defined? ADMINEMAIL
YOURSITE = 'scheduler.yarmouth-rowing.org' unless defined? YOURSITE

# Google Calendar and email items
EVENTCALENDAR = "https://www.google.com/calendar/hosted/yarmouth-rowing.org/embed?src=scheduler%40yarmouth-rowing.org&ctz=America/New_York" unless defined? EVENTCALENDAR
TIDECALENDAR = "https://www.google.com/calendar/hosted/yarmouth-rowing.org/embed?src=yarmouth-rowingorg_0ingqags0ib0vuutvegtjckopg%40group.calendar.google.com&ctz=America/New_York&color=%2328754E&mode=WEEK" unless defined? TIDECALENDAR
...
ExceptionNotifier.sender_address = %("Scheduler Error" <donotreply@yarmouth-rowing.org>)
